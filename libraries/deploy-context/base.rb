...
module Context
  module Base
    ...
    #   load_dependency(self, 'simplecov', 'simplecov_setup')
    #   load_dependency(self, 'git-version-bump', 'git-version-bump')
    #   load_dependency(self, 'cucumber', 'cucumber')
    #   load_dependency(self, 'cucumber', 'cucumber/cli/main')
    #   load_dependency(self, 'cucumber', 'cucumber/rspec/disable_option_parser')
    # end
